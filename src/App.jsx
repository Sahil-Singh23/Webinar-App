  ...
  return (
    <section className="min-h-screen bg-slate-950 text-white overflow-hidden ">
      <div className='flex flex-col mx-auto gap-15 items-center justify-center h-200'>
        ...
        <span className='text-white/70 text-[14px]'>Please confirm your birth year. This data will not be stored.</span>
        <input type='text' placeholder="Your birth year" className='h-10 mx-auto p-4 -mt-10 w-60 bg-slate-800 border border-gray-700 rounded-3xl'></input>
        <button className='flex items-center justify-center h-10 mx-auto p-4 -mt-4 w-60 bg-slate-800 border border-gray-700 rounded-xl hover:bg-slate-600 transition transiton-1000'>Continue</button>
      </div>
    </section>
  );
}
